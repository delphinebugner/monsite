class AppBackend {
  ...
  static async getUrl(
    ...
    let path =
      process.env.REACT_APP_SERVER_BASE_URL +
      '/' +
      AppBackend.cloudinaryControllerEntrypoint +
      '/url/' +
      src;
  ...
  static async getUrlFixedHeight(
    src: string,
    size: number,
  ): Promise<{ src: string; url: string }> {
